...
| `typeName` | `ZodLiteral` | - | node\_modules/.pnpm/zod@3.23.8/node\_modules/zod/lib/types.d.ts:752 |
| `value` | `T` | - | node\_modules/.pnpm/zod@3.23.8/node\_modules/zod/lib/types.d.ts:751 |
