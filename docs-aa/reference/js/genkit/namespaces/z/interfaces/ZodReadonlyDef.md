...
| `innerType` | `T` | - | node\_modules/.pnpm/zod@3.23.8/node\_modules/zod/lib/types.d.ts:932 |
| `typeName` | `ZodReadonly` | - | node\_modules/.pnpm/zod@3.23.8/node\_modules/zod/lib/types.d.ts:933 |
