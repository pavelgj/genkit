...
| `getter` | () => `T` | - | node\_modules/.pnpm/zod@3.23.8/node\_modules/zod/lib/types.d.ts:742 |
| `typeName` | `ZodLazy` | - | node\_modules/.pnpm/zod@3.23.8/node\_modules/zod/lib/types.d.ts:743 |
